# 크롤링(Crawling):브라우저 드라이버를 이용하여 실제로 각 페이지를 이동하며 '동적'으로 데이터를 수집하는 방법

# 웹 스크래핑(Scrapping):웹 페이지의 응답을 받아 데이터를 분석하여 필요한 데이터를 수집하는 방법 

# 파이썬 스크래핑 패키지:beatifulsoup4
# 파있너 크롤링 패키지:selenium
...
# <Response [100]> 추가요청 기다림
# <Response [200]> 성공
# <Response [300]> 리소스 위치 바뀜
# <Response [400]> 요청자(클라이언트) 오류
